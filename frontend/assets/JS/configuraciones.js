/**
 * Módulo: Configuraciones de Perfil (frontend)
 * Propósito: Editar campos del perfil (nombre, teléfono, dirección) y cambiar contraseña
 *            mediante llamadas a la API protegida del backend.
 */
