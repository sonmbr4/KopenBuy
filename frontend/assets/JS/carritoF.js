/**
 * Módulo: Carrito - Página (frontend)
 * Propósito: Lógica específica de la vista de carrito: checkout, validaciones de pago,
 *            resumen y utilidades visuales.
 * Dependencias: Bootstrap Modals/Alerts, API `/api/pedido`.
 */
