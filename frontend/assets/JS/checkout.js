/**
 * Módulo: Checkout (frontend)
 * Propósito: Valida formulario de pago/envío, construye payload y realiza la orden.
 * Dependencias: Bootstrap Toasts, API `/api/pedido` y estado global `cart`.
 */
