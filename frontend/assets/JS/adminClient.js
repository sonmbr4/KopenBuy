/**
 * Módulo: Admin - Clientes (frontend)
 * Propósito: Gestiona UI para ver, editar estado y eliminar clientes en el panel de administración.
 * Dependencias: Bootstrap Modals, Fetch API, rutas `/usuario/*`.
 */
