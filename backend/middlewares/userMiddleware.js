 ...
 * Propósito: Valida JWT desde headers o cookies, adjunta `req.user` y `res.locals.user`.
 * Comportamiento: Para rutas API devuelve 401; para vistas redirige a `/login`.
 */
