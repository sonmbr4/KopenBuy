 ...
 * Propósito: Gestiona operaciones de listado, detalle, creación, actualización,
 *            eliminación y recursos asociados (imágenes) para productos.
 * Rutas relacionadas: ver `backend/routes/adminRouts.js` y otras rutas de productos.
 */
