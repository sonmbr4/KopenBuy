...
const { getFeaturedProducts, getProductsByCategory, getAllProducts, getProductById } = require('./controllers/productsController');
...
app.get('/productos/:id', async (req, res) => {
  try {
    ...
    res.render('sections/productoDetalle', {
      producto,
      comentarios
    });
  } catch (error) {
