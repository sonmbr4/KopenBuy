/**
 * Rutas: Carrito (API)
 * Propósito: Endpoints para agregar, obtener, actualizar cantidades, eliminar y vaciar el carrito.
 * Middlewares: `authMiddleware` (requiere sesión).
 * Modelos: `Cart`, `Product`.
 */
